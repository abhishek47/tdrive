                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('company.register') }}">
                        ...
                        <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                         ...
                         <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                            <label for="address" class="col-md-4 control-label">City</label>
                        ...
                        <div class="form-group{{ $errors->has('zip') ? ' has-error' : '' }}">
                            <label for="zip" class="col-md-4 control-label">Pin Code</label>
                         ...
                         <div class="form-group{{ $errors->has('phones') ? ' has-error' : '' }}">
                            <label for="phones" class="col-md-4 control-label">Phone Nos.</label>
